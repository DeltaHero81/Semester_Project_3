...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        std::string front_left_wheel_command_joint_name = "wheel_left1_joint";
        std::string front_right_wheel_command_joint_name = "wheel_right1_joint";
        std::string rear_right_wheel_command_joint_name = "wheel_right2_joint";
        std::string rear_left_wheel_command_joint_name = "wheel_left2_joint";
        ...
        struct Kinematics {
            double wheels_radius = 0.033;
            double sum_of_robot_center_projection_on_X_Y_axis = 1.2;
