...
: ${AMENT_CURRENT_PREFIX:="/home/papalist/tek_expo_demo_3_ws/install/bumperbot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bumperbot_controller/environment/library_path.sh"
